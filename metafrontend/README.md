...
A modern Next.js application for creating SPL tokens on Solana blockchain with custom metadata and logo support.

This is the **frontend application** designed to work with the separate `metabackend` API.
...
- **Backend URL Configuration**: See [BACKEND_CONFIGURATION.md](./BACKEND_CONFIGURATION.md) - **Important!**
- **Backend Setup**: See the `metabackend` repository
