# metafrontend - SPL Token Creator Frontend

Standalone Next.js frontend application for creating SPL tokens on Solana with metadata and logo support.
...
2. Configure environment variables (see `BACKEND_CONFIGURATION.md`)
3. Deploy

For detailed backend URL configuration, see [`BACKEND_CONFIGURATION.md`](./BACKEND_CONFIGURATION.md)
...
⚠️ **Backend URL Configuration**: See [`BACKEND_CONFIGURATION.md`](./BACKEND_CONFIGURATION.md) for detailed instructions on configuring the backend API URL.

## Backend Repository

This frontend requires the metabackend API to function. See: https://github.com/ALEX-SHR-SUDO/metabackend
